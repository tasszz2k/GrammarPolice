...
final class NotificationService: NSObject {
    ...
    func showTranslationExploreDialog(original: String, simple: String, extended: String, targetLanguage: String) {
        ExploreDialogPresenter.presentModal(payload: ExploreDialogPayload(
            windowTitle: "Translation to \(targetLanguage)",
            original: original,
            primaryLabel: "Translation (\(targetLanguage))",
            primary: simple,
